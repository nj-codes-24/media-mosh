...
export const toolRegistry: ToolMetadata[] = [
  ...
  { id: 'video-stabilizer', name: 'Video Stabilizer', category: 'video', description: 'Smooth out shaky video footage', icon: MoveHorizontal, status: 'ready', inputFormats: ['video/mp4', 'video/webm', 'video/quicktime'], outputFormats: ['video/webm'], processingEngine: 'Optical Flow (Lucas-Kanade)', features: ['Motion Tracking', 'Camera Trajectory Smoothing'] },
  { id: 'video-bg-remover', name: 'Video BG Remover', category: 'video', description: 'Remove video background via AI', icon: Layers, status: 'ready', inputFormats: ['video/mp4', 'video/webm'], outputFormats: ['video/webm'], processingEngine: 'Transformers.js + WebCodecs', features: ['Transparent Export', 'Proxy Masking'] },
  ...
  { id: 'audio-splitter', name: 'Audio Splitter', category: 'audio', description: 'Isolate Vocals, Bass, and Drums', icon: Scissors, status: 'ready', inputFormats: ['audio/mpeg', 'audio/wav', 'audio/ogg', 'audio/x-m4a'], outputFormats: ['audio/wav'], processingEngine: 'DSP Phase/Frequency Isolation', features: ['Vocal Remover', 'Stem Isolation'] },
  ...
  { id: 'pdf-remove-page', name: 'Remove Pages', category: 'pdf', description: 'Quickly delete pages by number', icon: FileMinus, status: 'ready', inputFormats: ['application/pdf'], outputFormats: ['application/pdf'], processingEngine: 'PDF-lib (WASM)' },
